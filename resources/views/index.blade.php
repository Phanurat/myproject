...
<head>
  ...
  <title>S.SUPER CABLE | STOCK</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="" href="/assets/img/st.png" />
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <center><img width="200 px" src="/img/logo_ss.png"><br>
    <!-- <h3><b>STOCK </b>2023</h3> <br>  -->
    <h5>Please Login</h5></center><br>
